...
# In total, there are 3 different starting indexes (i = 1, i = 3, i = 4) where we can reach the end with some
# number of jumps.
# Example 3:
#
# Input: [5,1,3,4,2]
...
'''
Initial thought: Build a graph with even case and odd case first?
Once the graph is built, work from backward?
