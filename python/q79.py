...
'''
start from (0,0) to (max_i, max_j),

Check if the current position is the same as the index of the word i am looking at.
If matches, do dfs on next index, with adjacent positions.
'''
class Solution:
    def exist(self, board: List[List[str]], word: str) -> bool:
        ...
        def dfs(idx, i, j):
            ...
            if (idx, i, j) in visited:
                return visited[idx, i, j]
            ...
            if word[idx] == board[i][j]:
                ...
                for di, dj in ((0, 1), (1, 0), (-1, 0), (0, -1)):
                    if 0 <= i + di < max_i and 0 <= j + dj < max_j:
                        possible |= dfs(idx+1, i+di, j+dj)

                board[i][j] = word[idx]
                visited[idx, i, j] = possible
                return possible
        ...
        for cur_i in range(max_i):
            for cur_j in range(max_j):
                if dfs(0, cur_i, cur_j):
                    return True
        return False
...
if __name__ == '__main__':
    board = [["b", "a", "a", "b", "a", "b"], ["a", "b", "a", "a", "a", "a"], ["a", "b", "a", "a", "a", "b"],
     ...
     ["a", "a", "b", "a", "a", "b"]]
    given = "aabbbbabbaababaaaabababbaaba"

    s = Solution()
    print(s.exist(board, given))
    ...
    given = ""
    print(s.exist(board, given))
