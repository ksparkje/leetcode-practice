...
# this case, 6 units of rain water (blue section) are being trapped. Thanks Marcos for
...
class Solution:
    def trap(self, height: 'List[int]') -> 'int':
        ...
        total_min = [min(left, right)
                     for left, right
                     in zip(from_left_increasing,
                            reversed(from_right_increasing))]
